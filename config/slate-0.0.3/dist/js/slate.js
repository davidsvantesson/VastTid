...
(function($, Sortable) {
  ...
  $.extend($.fn, {
    ...
    itemDynamicList: function() {
      this.each(function() {
        ...
        var $addButton = $('<div class="item add-item">Add favorite stop...</div>');

        $list.append($addButton);

        $addButton.click(function() {
          if ($list.children().length-1>=10) {
            window.alert('Maximum 10 favorites');
          }
          else {
            var $inbox = $('<label class="item">'
                            ...
                            //  + '<div class="item add-item">Add direction...</div>'
                            + '</div>'
            ...
            var $addButton = $('<div class="item add-item">Add direction...</div>');

            var $direlem = $inbox.find('.item-dynamic-list-direction')
            $direlem.append($addButton);

            $addButton.click(function() {
              if ($direlem.children().length-1>=3) {
                window.alert('Maximum 3 directions');
              }
              else {
                var $inboxdir = $('<label class="item">'
                                + '<div class="item-input-wrapper">'
                ...
                $inboxdir.append($deleteButton);

                $inboxdir.insertBefore($direlem.children().last());
              }
            });
    ...
    itemDynamicListDirection: function() {
      this.each(function() {
        var $list = $(this);
  ...
  $(function() {
    ...
    $('.item-dynamic-list-direction').itemDynamicListDirection();
  });
}(Zepto, Sortable));
